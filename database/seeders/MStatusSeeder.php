...
class MStatusSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['name' => '却下', 'sort_order' => 3, 'created_at' => $now, 'updated_at' => $now],
            ['name' => '合格', 'sort_order' => 4, 'created_at' => $now, 'updated_at' => $now],
            ['name' => '不合格', 'sort_order' => 6, 'created_at' => $now, 'updated_at' => $now],
        ];
